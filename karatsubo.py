...
class TestKaratsuba(unittest.TestCase):
    ...
    def test_large_numbers(self):
        self.assertEqual(
            karatsuba(1234567891337228, 9876543214443434),
            12193263129956437967298024360952,
        )
        self.assertEqual(
            karatsuba(999999999933399494848848, 98723498126234912835691834659826345),
            98723498119659877990195781527561627242338570018193703300560,
        )
